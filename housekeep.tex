...
\item TA:  瀧澤 将音 （たきざわまさと） m.taki.x7@keio.jp
\item SA:  宮下空唯　（みやした　くう）ku.miyashita2021@keio.jp
\item SA: 青野　大洋（あおの　たいよう） aonotaiyo@keio.jp
\item SA: 田村　茉莉 (たむら　まり） t23505mt@sfc.keio.ac.jp
\item 教育体験：岡　尚史 （おかたかふみ）　第３、４、５回担当：takafumi@sfc.wide.ad.jp
\end{itemize}
基本、授業時間中に相談してください。授業時間外はK-LMSのmail機能でお願いします（TA/SAにも通知されます）。
\end{slide}
...
\item 第2回 4/21	関数
\item 第3回 4/28　極限
\item 第4回 5/12　平均変化率・導関数（微分）
\item 第5回 5/19	様々な関数の微分
\item 第6回 5/26	逆関数、逆関数の微分
\item 第7回 6/2　接線・法線、ロピタルの定理
\item 第8回 6/9	高次導関数、テイラーの定理
\item 第9回 6/16　二変数関数、偏微分
\item 第10回 6/23　不定積分
\item 第11回 6/30　定積分
\item 第12回 7/7 　多変数関数の積分
\item 第13回 7/14　　総復習
\item 第14回 7/21 　授業内試験
\end{itemize}
\end{slide}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
