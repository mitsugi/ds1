...
\item 卒業後のキャリアについて改めて考えてもらうことが一つの狙いであった。
\end{itemize}
\end{slide}
...
\begin{slide}{課題\#2}
\begin{enumerate}
\item 5で割って2余る自然数の集合を内包的記法で記述せよ。
...
\item NewProjectをBlank Projectで作成（微積など、適当に名前をつける。微積で作るファイルをこのプロジェクトに入れる）
...
\item latexmkrcというファイルを新たに作成。latexmkrcの例は２回目のモジュールにある
\end{itemize}
